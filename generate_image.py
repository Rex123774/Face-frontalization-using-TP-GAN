...
if __name__ == "__main__":
    #model_dir = 'E:/BE_PROJECTNO_9/latest_tpgan/generator/latest_dltp-gan/epoch2997_loss0.252.hdf5'
    model_dir = 'C:/Users/RONIX/latest_tpgan_19April23/out_data/weights/gen/epoch1777_loss0.251.hdf5'
    side_img = 'C:/Users/RONIX/latest_tpgan_19April23/Demo/input_side_image/01_side.jpg'
    #side_img = 'E:/BE_PROJECTNO_9/latest_tpgan/dataset/dataset/206/206_01_01_130_05_cropped_test.jpg'
    dest_gen_image = 'C:/Users/RONIX/latest_tpgan_19April23/Demo/generated_image/'
    #dest_gen_image ='C:/Users/RONIX/face-frontalization-webapp/webapp/public/output-images/'
    
    model = build_model(model_dir)

    side_face_image = cv2.imread(side_img)
    ...
    gen_img_path = os.path.join(dest_gen_image, 'output_image.jpg')
    print("success")
